...
/**
 * ALFRED — the butler. Reads new raw capture since the last curation and folds
 ...
 *
 * Guarantee: if no curator is reachable, ALFRED does NOT touch the board and
...
function buildPrompt(existingBoard, rawDeltas) {
  return [
    'You are ALFRED, a curation function. You DO NOT chat. You output a markdown',
